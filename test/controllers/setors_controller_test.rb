...
class SetorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setor" do
    assert_difference("Setor.count") do
      post setors_url, params: { setor: { nome: @setor.nome, unidade_id: @setor.unidade_id } }
    end
  ...
  test "should update setor" do
    patch setor_url(@setor), params: { setor: { nome: @setor.nome, unidade_id: @setor.unidade_id } }
