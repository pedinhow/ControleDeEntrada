...
ActiveRecord::Schema[7.1].define(version: 2023_10_07_204908) do
  ...
  create_table "visits", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["funcionario_id"], name: "index_visits_on_funcionario_id"
    t.index ["setor_id"], name: "index_visits_on_setor_id"
    t.index ["visitante_id"], name: "index_visits_on_visitante_id"
  end

  add_foreign_key "funcionarios", "setors"
  add_foreign_key "setors", "unidades"
  add_foreign_key "visits", "funcionarios"
  add_foreign_key "visits", "setors"
  add_foreign_key "visits", "visitantes"
end
